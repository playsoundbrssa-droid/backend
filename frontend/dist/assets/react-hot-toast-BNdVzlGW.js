import{r}from"./react-qrIPZ5Hk.js";import{h as g,u as H,w as b,m as L}from"./goober-wofAfydu.js";var S=e=>typeof e=="function",D=(e,t)=>S(e)?e(t):e,F=(()=>{let e=0;return()=>(++e).toString()})(),P=(()=>{let e;return()=>{if(e===void 0&&typeof window<"u"){let t=matchMedia("(prefers-reduced-motion: reduce)");e=!t||t.matches}return e}})(),B=20,$="default",T=(e,t)=>{let{toastLimit:a}=e.settings;switch(t.type){case 0:return{...e,toasts:[t.toast,...e.toasts].slice(0,a)};case 1:return{...e,toasts:e.toasts.map(s=>s.id===t.toast.id?{...s,...t.toast}:s)};case 2:let{toast:i}=t;return T(e,{type:e.toasts.find(s=>s.id===i.id)?1:0,toast:i});case 3:let{toastId:o}=t;return{...e,toasts:e.toasts.map(s=>s.id===o||o===void 0?{...s,dismissed:!0,visible:!1}:s)};case 4:return t.toastId===void 0?{...e,toasts:[]}:{...e,toasts:e.toasts.filter(s=>s.id!==t.toastId)};case 5:return{...e,pausedAt:t.time};case 6:let n=t.time-(e.pausedAt||0);return{...e,pausedAt:void 0,toasts:e.toasts.map(s=>({...s,pauseDuration:s.pauseDuration+n}))}}},k=[],N={toasts:[],pausedAt:void 0,settings:{toastLimit:B}},y={},j=(e,t=$)=>{y[t]=T(y[t]||N,e),k.forEach(([a,i])=>{a===t&&i(y[t])})},M=e=>Object.keys(y).forEach(t=>j(e,t)),U=e=>Object.keys(y).find(t=>y[t].toasts.some(a=>a.id===e)),z=(e=$)=>t=>{j(t,e)},Y={blank:4e3,error:4e3,success:2e3,loading:1/0,custom:4e3},K=(e={},t=$)=>{let[a,i]=r.useState(y[t]||N),o=r.useRef(y[t]);r.useEffect(()=>(o.current!==y[t]&&i(y[t]),k.push([t,i]),()=>{let s=k.findIndex(([m])=>m===t);s>-1&&k.splice(s,1)}),[t]);let n=a.toasts.map(s=>{var m,v,h;return{...e,...e[s.type],...s,removeDelay:s.removeDelay||((m=e[s.type])==null?void 0:m.removeDelay)||(e==null?void 0:e.removeDelay),duration:s.duration||((v=e[s.type])==null?void 0:v.duration)||(e==null?void 0:e.duration)||Y[s.type],style:{...e.style,...(h=e[s.type])==null?void 0:h.style,...s.style}}});return{...a,toasts:n}},Q=(e,t="blank",a)=>({createdAt:Date.now(),visible:!0,dismissed:!1,type:t,ariaProps:{role:"status","aria-live":"polite"},message:e,pauseDuration:0,...a,id:(a==null?void 0:a.id)||F()}),x=e=>(t,a)=>{let i=Q(t,e,a);return z(i.toasterId||U(i.id))({type:2,toast:i}),i.id},d=(e,t)=>x("blank")(e,t);d.error=x("error");d.success=x("success");d.loading=x("loading");d.custom=x("custom");d.dismiss=(e,t)=>{let a={type:3,toastId:e};t?z(t)(a):M(a)};d.dismissAll=e=>d.dismiss(void 0,e);d.remove=(e,t)=>{let a={type:4,toastId:e};t?z(t)(a):M(a)};d.removeAll=e=>d.remove(void 0,e);d.promise=(e,t,a)=>{let i=d.loading(t.loading,{...a,...a==null?void 0:a.loading});return typeof e=="function"&&(e=e()),e.then(o=>{let n=t.success?D(t.success,o):void 0;return n?d.success(n,{id:i,...a,...a==null?void 0:a.success}):d.dismiss(i),o}).catch(o=>{let n=t.error?D(t.error,o):void 0;n?d.error(n,{id:i,...a,...a==null?void 0:a.error}):d.dismiss(i)}),e};var V=1e3,W=(e,t="default")=>{let{toasts:a,pausedAt:i}=K(e,t),o=r.useRef(new Map).current,n=r.useCallback((l,p=V)=>{if(o.has(l))return;let c=setTimeout(()=>{o.delete(l),s({type:4,toastId:l})},p);o.set(l,c)},[]);r.useEffect(()=>{if(i)return;let l=Date.now(),p=a.map(c=>{if(c.duration===1/0)return;let w=(c.duration||0)+c.pauseDuration-(l-c.createdAt);if(w<0){c.visible&&d.dismiss(c.id);return}return setTimeout(()=>d.dismiss(c.id,t),w)});return()=>{p.forEach(c=>c&&clearTimeout(c))}},[a,i,t]);let s=r.useCallback(z(t),[t]),m=r.useCallback(()=>{s({type:5,time:Date.now()})},[s]),v=r.useCallback((l,p)=>{s({type:1,toast:{id:l,height:p}})},[s]),h=r.useCallback(()=>{i&&s({type:6,time:Date.now()})},[i,s]),u=r.useCallback((l,p)=>{let{reverseOrder:c=!1,gutter:w=8,defaultPosition:O}=p||{},C=a.filter(f=>(f.position||O)===(l.position||O)&&f.height),R=C.findIndex(f=>f.id===l.id),A=C.filter((f,I)=>I<R&&f.visible).length;return C.filter(f=>f.visible).slice(...c?[A+1]:[0,A]).reduce((f,I)=>f+(I.height||0)+w,0)},[a]);return r.useEffect(()=>{a.forEach(l=>{if(l.dismissed)n(l.id,l.removeDelay);else{let p=o.get(l.id);p&&(clearTimeout(p),o.delete(l.id))}})},[a,n]),{toasts:a,handlers:{updateHeight:v,startPause:m,endPause:h,calculateOffset:u}}},Z=g`
from {
