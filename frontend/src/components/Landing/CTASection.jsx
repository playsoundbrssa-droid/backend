...
export default function CTASection({ onLoginClick }) {
    return (
        <section id="cta" className="py-12 md:py-16 px-4 md:px-6 relative">
            <div className="container mx-auto">
                <div className="relative glass-panel rounded-[2rem] md:rounded-[3rem] p-8 md:p-20 text-center border-neon-blue/20 overflow-hidden reveal">
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto">
                        ...
                        <p className="text-gray-400 text-base md:text-xl mb-8 md:mb-12 leading-relaxed">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
                            <button 
                                ...
                                className="px-8 md:px-10 py-4 md:py-5 bg-white text-black rounded-2xl font-bold text-base md:text-lg hover:bg-neon-blue hover:text-white transition-all neon-glow-blue hover:scale-105 active:scale-95"
                            >
                                Acessar Player Grátis
                            </button>
                            <button className="px-8 md:px-10 py-4 md:py-5 bg-white/5 text-white border border-white/10 rounded-2xl font-bold text-base md:text-lg hover:bg-white/10 transition-all flex items-center justify-center gap-2 active:scale-95">
